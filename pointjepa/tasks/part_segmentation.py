...
from pointjepa.datasets import ShapeNetPartDataModule  # allow shorthand notation
from pointjepa.models import PointJepaPartSegmentation

if __name__ == "__main__":
    cli = LightningCLI(
        PointJepaPartSegmentation,
        trainer_defaults={
